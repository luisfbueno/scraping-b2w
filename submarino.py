...
for index, link in enumerate(links_df["Link"]):
    ...
    # Gerando user agent aleatorio e montando header
    user_agent = random.choice(user_agent_list)
    headers = {'User-Agent': user_agent}
    link = link.replace("americanas", "submarino")
...
path_save = os.path.join("output", "Submarino.xlsx")
